...
function initAnchors() {
  new SmoothScroll({
    anchorLinks: '.nav-primary li > a[href^="#"]:not([href="#"])',
  ...
  new SmoothScroll({
    anchorLinks: 'a.scroll-btn[href^="#"]:not([href="#"])',
    extraOffset: function() {
      var totalHeight = 0;
      jQuery('.header').each(function() {
        var $box = jQuery(this);
  ...
  new SmoothScroll({
    anchorLinks: 'a.back-to-top[href^="#"]:not([href="#"]), .logo a[href^="#"]:not([href="#"])',
    extraOffset: 0,
    wheelBehavior: 'none'
  });
}
...
function initFocusClass() {
  jQuery('.contact-form-box').addFocusClass({
    focusClass: 'active',
...
function initDetectDevice() {
  ...
  var activeClass = 'no-touch-device';
  isTouchDevice ? false : body.addClass(activeClass);
}
